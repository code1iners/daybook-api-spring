...
import cc.codeliners.daybookapi.DaybookApiApplication;
import cc.codeliners.daybookapi.config.SecurityConfig;
import cc.codeliners.daybookapi.controller.HelloController;
import cc.codeliners.daybookapi.controller.UserController;
...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  private ImportAwareBeanPostProcessor createImportAwareBeanPostProcessor() {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "cc.codeliners.daybookapi.config.SecurityConfig");
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("cc.codeliners.daybookapi.DaybookApiApplication", DaybookApiApplication.class)
        .instanceSupplier(DaybookApiApplication::new).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("userService", UserService.class).withConstructor(UserRepository.class, PasswordEncoder.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> new UserService(attributes.get(0), attributes.get(1)))).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("passwordEncoder", PasswordEncoder.class).withFactoryMethod(SecurityConfig.class, "passwordEncoder")
    ...
    BeanDefinitionRegistrar.of("org.mybatis.spring.boot.autoconfigure.MybatisAutoConfiguration$MapperScannerRegistrarNotFoundConfiguration", MybatisAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration.class)
        .instanceSupplier(MybatisAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration::new).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("sqlSessionFactory", SqlSessionFactory.class).withFactoryMethod(MybatisAutoConfiguration.class, "sqlSessionFactory", DataSource.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(MybatisAutoConfiguration.class).sqlSessionFactory(attributes.get(0)))).register(beanFactory);
    BeanDefinitionRegistrar.of("sqlSessionTemplate", SqlSessionTemplate.class).withFactoryMethod(MybatisAutoConfiguration.class, "sqlSessionTemplate", SqlSessionFactory.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(MybatisAutoConfiguration.class).sqlSessionTemplate(attributes.get(0)))).register(beanFactory);
    ...
    BeanDefinitionRegistrar.of("userRepository", ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, UserRepository.class, User.class, String.class)).withConstructor(Class.class)
        .instanceSupplier((instanceContext) -> {
      ...
      bd.getConstructorArgumentValues().addIndexedArgumentValue(0, "cc.codeliners.daybookapi.repository.UserRepository");
